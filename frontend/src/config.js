...
export const POST_CREATE_USER = import.meta.env.POST_CREATE_USER || '/api/users/create';
export const GET_LIST_USERS = import.meta.env.GET_LIST_USERS || '/api/users/list';